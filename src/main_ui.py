...
class MainWindowUI:
    ...
    def init_ui(self, main_window):
        ...
        self.file_toolbar = QToolBar("File", main_window)
        self.image_toolbar = QToolBar("Image", main_window)
        self.analyze_toolbar = QToolBar("Analyze", main_window)
        ...
        main_window.addToolBar(self.file_toolbar)
        main_window.addToolBar(self.image_toolbar)
        main_window.addToolBar(Qt.LeftToolBarArea, self.analyze_toolbar)
        ...
        self.action_zoom_in = QAction(main_window)
        self.action_zoom_in.setObjectName("action_zoom_in")
        icon = QIcon()
        icon.addPixmap(QPixmap("icons/zoom_in.png"), QIcon.Normal, QIcon.Off)
        self.action_zoom_in.setIcon(icon)

        self.action_zoom_out = QAction(main_window)
        self.action_zoom_out.setObjectName("action_zoom_out")
        icon = QIcon()
        icon.addPixmap(QPixmap("icons/zoom_out.png"), QIcon.Normal, QIcon.Off)
        self.action_zoom_out.setIcon(icon)

        self.action_zoom_off = QAction(main_window)
        self.action_zoom_off.setObjectName("action_zoom_off")
        icon = QIcon()
        icon.addPixmap(QPixmap("icons/zoom_off.png"), QIcon.Normal, QIcon.Off)
        self.action_zoom_off.setIcon(icon)
        ...
        self.menu_image.addAction(self.action_zoom_off)
        ...
        self.file_toolbar.addAction(self.action_cascade)
        self.image_toolbar.addAction(self.action_rename)
        self.image_toolbar.addAction(self.action_duplicate)
        self.image_toolbar.addAction(self.action_zoom_in)
        self.image_toolbar.addAction(self.action_zoom_out)
        self.image_toolbar.addAction(self.action_zoom_off)
        self.image_toolbar.addAction(self.action_image_info)
        self.analyze_toolbar.addAction(self.action_histogram)
        self.analyze_toolbar.addAction(self.action_profile)
        self.analyze_toolbar.addAction(self.action_object_features)
    ...
    def retranslate_ui(self, main_window):
        ...
        self.action_zoom_in.setText(_translate(_main_title, "Zoom In"))
        self.action_zoom_out.setText(_translate(_main_title, "Zoom Out"))
        self.action_zoom_off.setText(_translate(_main_title, "Zoom Off"))
        ...
        self.action_zoom_in.setStatusTip(_translate(_main_title, "Zoom in selected image"))
        self.action_zoom_out.setStatusTip(_translate(_main_title, "Zoom out selected image"))
        self.action_zoom_off.setStatusTip(_translate(_main_title, "Zoom off image to normal size"))
        ...
        self.action_zoom_in.setShortcuts(QKeySequence.keyBindings(16) + ["Ctrl+="])
        self.action_zoom_out.setShortcuts(QKeySequence.keyBindings(17) + ["Ctrl+_"])
        self.action_rename.setShortcut("Ctrl+R")
        self.action_duplicate.setShortcut("Ctrl+D")
        self.action_zoom_off.setShortcut("Ctrl+Q")
