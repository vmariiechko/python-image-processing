...
class MainWindowUI:
    ...
    def init_ui(self, main_window):
        ...
        self.action_object_properties = QAction(main_window)
        self.action_object_properties.setObjectName("action_object_properties")
        icon = QIcon()
        icon.addPixmap(QPixmap("icons/analyze.png"), QIcon.Normal, QIcon.Off)
        self.action_object_properties.setIcon(icon)
        ...
        self.menu_analyze.addAction(self.action_object_properties)
    ...
    def retranslate_ui(self, main_window):
        ...
        self.action_object_properties.setText(_translate(_window_title, "Object Properties"))
