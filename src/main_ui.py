...
class MainWindowUI:
    ...
    def init_ui(self, main_window):
        ...
        self.action_segmentation = QAction(main_window)
        self.action_segmentation.setObjectName("action_segmentation")
        icon = QIcon()
        icon.addPixmap(QPixmap("icons/threshold.png"), QIcon.Normal, QIcon.Off)
        self.action_segmentation.setIcon(icon)
        ...
        self.menu_process.addAction(self.action_segmentation)
    ...
    def retranslate_ui(self, main_window):
        ...
        self.action_segmentation.setText(_translate(_window_title, "Segmentation"))
